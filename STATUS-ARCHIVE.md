# Status archive — tournament-manager

Older handoff-log entries moved out of `STATUS.md` on 2026-08-27 to keep the
front-door doc lean. Same append-only log, newest on top. Nothing here is live
guidance — it is history. Current status lives in [`STATUS.md`](./STATUS.md).
